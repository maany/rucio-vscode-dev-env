    ...
    def convert(self, value, param, ctx):
        ...
        try:
            ...
            if value == "adhoc":
                ...
                return value
            if value == "ui":
                from debug_utils.rucio_ui_debug import ssl_context, PeerCertWSGIRequestHandler
                handler = PeerCertWSGIRequestHandler
                return ssl_context
            if value  == 'server':
                from debug_utils.rucio_server_debug import ssl_context
                handler = WSGIRequestHandler
                return ssl_context
